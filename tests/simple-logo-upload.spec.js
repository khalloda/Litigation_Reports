...
test.describe('Simple Client Logo Upload Test', () => {
  test('should test logo upload functionality directly', async ({ page }) => {
    ...
    const clientsLink = page.locator(
      'a[href*="clients"], [data-testid="nav-clients"], .nav-link:has-text("Clients"), .nav-link:has-text("العملاء")'
    );
    ...
    const addButton = page.locator(
      'button:has-text("Add"), .btn-primary:has-text("Add"), [data-testid="add-client-btn"], button:has-text("إضافة")'
    );
    ...
    const arabicNameInput = page.locator(
      'input[placeholder*="اسم العميل بالعربية"], input[placeholder*="Arabic client name"], input[name="client_name_ar"]'
    );
    ...
    const englishNameInput = page.locator(
      'input[placeholder*="اسم العميل بالإنجليزية"], input[placeholder*="English client name"], input[name="client_name_en"]'
    );
    ...
    const lawyerInput = page.locator(
      'input[placeholder*="المحامي"], input[placeholder*="lawyer"], input[name="contact_lawyer"]'
    );
