            ...
            return function (u, h) {
              ...
              for (let Ke = 0; Ke < k; ++Ke) {
                ...
                if (st == ',') x[Ke] = 'N';
                  ...
                  for (
                    let Mt = (Ke && x[Ke - 1] == '!') || (Xe < k && x[Xe] == '1') ? '1' : 'N',
                      wt = Ke;
                    wt < Xe;
                    ++wt
                  )
...
`
                ...
                for (var G = [], ee = void 0, me = 0; me < r.length; ++me) {
                  ...
                  if (Fe.type == 'bookmark' && pe.from == s && Fe.widgetNode) G.push(Fe);
                    ...
                    if (
                      ...
                      for (const Ke in Fe.attributes) (Q || (Q = {}))[Ke] = Fe.attributes[Ke];
                    Fe.collapsed && (!U || Si(U.marker, Fe) < 0) && (U = pe);
                  } else pe.from > s && x > pe.from && (x = pe.from);
                }
                if (ee)
                  for (let st = 0; st < ee.length; st += 2) ee[st + 1] == x && (E += ' ' + ee[st]);
                if (!U || U.from == s) for (let Xe = 0; Xe < G.length; ++Xe) Oo(t, 0, G[Xe]);
                if (U && (U.from || 0) == s) {
                  if (
          ...
          function hs(e, t, n) {
            ...
            for (let r = H('CodeMirror-linewidget'), i = t.node.firstChild, o = void 0; i; i = o)
          ...
          function Wo(e, t, n) {
            if ((_o(e, t.line, t, n, !0), t.rest))
              for (let r = 0; r < t.rest.length; r++) _o(e, t.rest[r], t, n, !1);
          }
          ...
          function li(e, t, n) {
            (Ct(e, 'beforeSelectionChange') || (e.cm && Ct(e.cm, 'beforeSelectionChange'))) &&
              (t = Qs(e, t, n));
            const r = (n && n.bias) || (Z(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
            (Dl(e, Fl(e, t, r, !0)),
              !(n && n.scroll === !1) &&
                e.cm &&
...
`
          ...
          for (let En = 1; En <= 12; En++) yr[En + 111] = yr[En + 63235] = 'F' + En;
          const nr = {};
          ((nr.basic = {
            Left: 'goCharLeft',
            Right: 'goCharRight',
            ...
            function E(G) {
              ...
              if (me)
                if (Z(me, v) != 0) {
                  ...
                  const Fe = G.clientY < x.top ? -20 : G.clientY > x.bottom ? 20 : 0;
                  Fe &&
                    setTimeout(
                      lt(e, function () {
...
`) &&
          ...
          function fo(e, t, n, r, i) {
            ...
            function h(Q) {
              ...
              if (r == 'codepoint') {
                ...
                if (isNaN(ee)) G = null;
                  ...
                  const me = n > 0 ? ee >= 55296 && ee < 56320 : ee >= 56320 && ee < 57343;
                  G = new L(
                    t.line,
            ...
            if (r == 'char' || r == 'codepoint') h();
              ...
              for (
                let v = null, k = r == 'group', x = e.cm && e.cm.getHelper(t, 'wordChars'), M = !0;
                !(n < 0 && !h(!M));
                M = !1
              ) {
                let E =
          ...
          function Ou(e, t, n, r, i) {
            ...
            function k(x) {
              if (x.nodeType == 1) {
                ...
                Q && h();
                for (let G = 0; G < x.childNodes.length; G++) k(x.childNodes[G]);
          ...
          function Pu(e, t, n) {
            ...
            function h(R, U, Q) {
              for (let G = -1; G < (u ? u.length : 0); G++)
                for (let ee = G < 0 ? s.map : u[G], me = 0; me < ee.length; me += 3) {
                  const pe = ee[me + 2];
                  if (pe == R || pe == U) {
            ...
            let v = h(l, a, n);
            if (v) return rn(v, i);
            for (let k = a.nextSibling, x = l ? l.nodeValue.length - n : 0; k; k = k.nextSibling) {
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          (C.defineMode('javascript', function (De, I) {
            ...
            function J() {
              for (let f = arguments.length - 1; f >= 0; f--) D.cc.push(arguments[f]);
            }
            function d() {
            ...
            function j(f, g) {
              const A = function () {
                ...
                if (W.lexical.type == 'stat') L = W.lexical.indented;
                  ...
                  for (let Z = W.lexical; Z && Z.type == ')' && Z.align; Z = Z.prev) L = Z.indented;
            ...
            function Lt(f, g, A) {
              for (let W = 3; W < arguments.length; W++) D.cc.push(arguments[W]);
    ...
    ka ||
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          function N(ie, O) {
            for (const q in ie)
              for (let z = O[q] || (O[q] = []), X = ie[q], ke = X.length - 1; ke >= 0; ke--)
                z.unshift(X[ke]);
          }
          function _(ie, O) {
        ...
        (function (C) {
          ...
          (C.defineMode('python', function (N, _) {
            ...
            function de(S, w, m) {
              ...
              for (let p = 0; p < q.length; p++) if (S.match(q[p])) return 'operator';
              return S.match(O)
                ? 'punctuation'
        ...
        (function (C) {
          ...
          ((C.findModeByMIME = function (K) {
            ...
            for (let $ = 0; $ < C.modeInfo.length; $++) {
              ...
              if (V.mimes) {
                for (let b = 0; b < V.mimes.length; b++) if (V.mimes[b] == K) return V;
              }
            }
            ...
            (C.findModeByExtension = function (K) {
              ...
              for (let $ = 0; $ < C.modeInfo.length; $++) {
                const V = C.modeInfo[$];
                if (V.ext) {
                  for (let b = 0; b < V.ext.length; b++) if (V.ext[b] == K) return V;
                }
              }
            }),
                ...
                token: function (p, c) {
                  if (((c.formatting = !1), p != c.thisLine.stream)) {
                    ...
                    if (
                      ...
                      const Y = p.match(/^\s*/, !0)[0].replace(/\t/g, re).length;
            ...
            (C.simpleMode = function (O, q) {
              ...
              for (const we in q)
                if (we != X && q.hasOwnProperty(we))
                  for (let te = (z[we] = []), re = q[we], ne = 0; ne < re.length; ne++) {
                    const se = re[ne];
              ...
              if (X) for (const ye in X) X.hasOwnProperty(ye) && (Ae[ye] = X[ye]);
              return Ae;
            }));
          function De(O, q) {
