...
export function RoleManagement() {
  ...
  const getResourceIcon = (resource: string) => {
    switch (resource) {
      ...
      case 'clients': return '👥'
      case 'cases': return '📋'
      case 'hearings': return '⚖️'
      case 'invoices': return '💰'
      case 'reports': return '📈'
      case 'users': return '👤'
      case 'system_settings': return '⚙️'
      case 'powers_of_attorney': return '📜'
      case 'documents': return '📄'
      case 'attendance': return '✅'
      case 'admin_work': return '🔧'
            ...
            <Card.Body>
              <div className="text-center">
                ...
                <p className="text-muted small mb-0">
                  نظام متقدم لإدارة الأدوار والصلاحيات
                </p>
              </div>
            </Card.Body>
          </Card>
        ...
        <Modal.Body>
          {selectedRole && (
            <div>
              ...
              {Object.entries(
                modifiedPermissions.reduce((acc, permission) => {
              ...
              {editingPermissions && (
                <Alert variant="info" className="mt-3">
                  <strong>تعديل الصلاحيات:</strong> انقر على أي صلاحية لإضافةها أو إزالتها من هذا الدور.
                </Alert>
              )}
            </div>
          )}
