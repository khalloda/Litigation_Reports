...
test.describe('Authentication System', () => {
  ...
  test('should display login page with proper branding', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="language-switcher"], .language-switcher')
    ).toBeVisible();
  ...
  test('should support RTL layout in Arabic', async ({ page }) => {
    ...
    await page.click(
      '[data-testid="language-switcher"] [data-lang="ar"], .language-switcher [data-lang="ar"]'
    );
    await page.waitForLoadState('networkidle');
  ...
  test('should be accessible with screen readers', async ({ page }) => {
    ...
    await expect(page.locator('input[type="email"], input[name="email"]')).toHaveAttribute(
      'aria-label'
    );
  ...
  test('should handle password reset functionality', async ({ page }) => {
    ...
    const resetLink = page.locator(
      'a[href*=reset], a[href*=forgot], text=Reset, text=نسيت كلمة المرور'
    );
