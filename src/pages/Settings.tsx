...
import { Settings as SettingsIcon, Shield, User, Globe, Database, Bell, Palette, Lock } from 'lucide-react'
...
export function Settings() {
  ...
  const settingsTabs = [
    ...
    { key: 'database', title: 'قاعدة البيانات', icon: Database, permission: 'system_settings:manage' },
