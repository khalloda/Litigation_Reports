...
test.describe('Simple Pages Verification', () => {
  test('should check that pages load without Coming Soon message', async ({ page }) => {
    ...
    for (const url of testUrls) {
      ...
      const comingSoonVisible = await page
  ...
  test('should verify specific page content', async ({ page }) => {
    ...
    const clientsPageHasCorrectContent =
      (await page
        .locator('text=إدارة العملاء')
        .isVisible()
        .catch(() => false)) ||
      (await page
    ...
    const casesPageHasCorrectContent =
      (await page
        .locator('text=إدارة القضايا')
        .isVisible()
        .catch(() => false)) ||
      (await page
        .locator('text=Cases')
    ...
    const hearingsPageHasCorrectContent =
      (await page
        .locator('text=إدارة الجلسات')
        .isVisible()
        .catch(() => false)) ||
      (await page
        .locator('text=Hearings')
        .isVisible()
        .catch(() => false)) ||
      (await page
        .locator('text=Hearing')
        .isVisible()
        .catch(() => false));
    ...
    const reportsPageHasCorrectContent =
      (await page
        .locator('text=التقارير')
        .isVisible()
        .catch(() => false)) ||
      (await page
