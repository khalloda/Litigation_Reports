...
async function testAPIResponseStructure() {
  ...
  try {
      ...
      try {
        ...
        return {
          ...
          responseStructure: {
            ...
            paginationKeys:
              data.data && data.data.pagination ? Object.keys(data.data.pagination) : [],
            fullResponse: data,
          },
        };
      } catch (error) {
    ...
    if (apiResponseTest.success) {
      ...
      console.log(
        `      - Has nested 'data' field: ${apiResponseTest.responseStructure.hasNestedData}`
      );
      console.log(
        `      - Has 'pagination' field: ${apiResponseTest.responseStructure.hasPagination}`
      );
      console.log(`      - Data array length: ${apiResponseTest.responseStructure.dataLength}`);
      console.log(
        `      - Pagination keys: ${apiResponseTest.responseStructure.paginationKeys.join(', ')}`
      );
    ...
    if (apiServiceTest.success) {
      ...
      console.log(
        `      - Has nested 'data' field: ${apiServiceTest.responseStructure.hasNestedData}`
      );
      console.log(
        `      - Has 'pagination' field: ${apiServiceTest.responseStructure.hasPagination}`
      );
